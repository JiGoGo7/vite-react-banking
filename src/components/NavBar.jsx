    ...
    return (
        <div className="navbar">
            <div className="nav-left">
                ...
                <button onClick={() => navigate('/aboutUs')} className="nav-button">
                    Про нас
                </button>
                <button onClick={() => navigate('/earnings')} className="nav-button">
                    Заробіток
                </button>
                <button onClick={() => navigate('/transfer')} className="nav-button">
                    Переказ
                </button>
                <button onClick={() => navigate('/credit')} className="nav-button">
                    Кредит
                </button>
            </div>
