                ...
                <>
                    ...
                    {credit ? (
                        <div className="creditP-card">
                            ...
                            <p>
                                <strong>Сума:</strong> {credit.requestedAmount} грн
                            </p>
                            <p>
                                <strong>До сплати:</strong> {credit.requestedAmount * 1.1} грн
                            </p>
                            <button className="creditP-btn" onClick={handlePayCredit}>
                                Погасити кредит
                            </button>
                        </div>
                    ) : (
                        <form className="creditP-form" onSubmit={handleCredit}>
                            ...
                            <input
                                ...
                                required
                            />
                            <button type="submit" className="creditP-btn">
                                Відправити
                            </button>
                        </form>
                    )}
